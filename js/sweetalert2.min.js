! function (e, t) {
    ...
    var q = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        Q = function () {
            var e = Z();
            return Array.prototype.slice.call(e.querySelectorAll("." + D.icon))
        },
        Y = function () {
            return m(D.title)
        },
    ...
    var x = {
        ...
        A = ["useRejections", "expectRejections"],
        T = function (e) {
        ...
        ue = function (e) {
            for (var t in e) T(t) || B('Unknown parameter "' + t + '"'), j(t) && l('The parameter "' + t + '" is deprecated and will be removed in the next major release.')
        },
            ...
            _main: function (e) {
                ...
                ! function (r) {
                    r.inputValidator || Object.keys(ve).forEach(function (e) {
                        r.input === e && (r.inputValidator = r.expectRejections ? ve[e] : Ae.adaptInputValidator(ve[e]))
                    }), (!r.target || "string" == typeof r.target && !document.querySelector(r.target) || "string" != typeof r.target && !r.target.appendChild) && (B('Target parameter is not valid, defaulting to "body"'), r.target = "body");
                    var e = void 0,
                        t = Z(),
                    ...
                    var g = X(),
                        v = parseInt(null === r.currentProgressStep ? Ae.getQueueStep() : r.currentProgressStep, 10);
                    r.progressSteps && r.progressSteps.length ? (U(g), S(g), v >= r.progressSteps.length && B("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), r.progressSteps.forEach(function (e, t) {
                    ...
                    if (r.imageUrl ? (x.setAttribute("src", r.imageUrl), x.setAttribute("alt", r.imageAlt), U(x), r.imageWidth ? x.setAttribute("width", r.imageWidth) : x.removeAttribute("width"), r.imageHeight ? x.setAttribute("height", r.imageHeight) : x.removeAttribute("height"), x.className = D.image, r.imageClass && W(x, r.imageClass)) : F(x), r.showCancelButton ? p.style.display = "inline-block" : F(p), r.showConfirmButton ? O(d, "display") : F(d), r.showConfirmButton || r.showCancelButton ? U(c) : F(c), d.innerHTML = r.confirmButtonText, p.innerHTML = r.cancelButtonText, d.setAttribute("aria-label", r.confirmButtonAriaLabel), p.setAttribute("aria-label", r.cancelButtonAriaLabel), d.className = D.confirm, W(d, r.confirmButtonClass), p.className = D.cancel, W(p, r.cancelButtonClass), r.buttonsStyling) {
                        ...
                        var A = window.getComputedStyle(d).getPropertyValue("background-color");
                        d.style.borderLeftColor = A, d.style.borderRightColor = A
                    ...
                    ae(r.footer, m), !0 === r.animation ? P(e, D.noanimation) : W(e, D.noanimation), r.showLoaderOnConfirm && !r.preConfirm && B("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request")
                    ...
                    switch (j.input) {
                        ...
                        case "select":
                            ...
                            if (x.innerHTML = "", j.inputPlaceholder) {
                                ...
                                A.innerHTML = j.inputPlaceholder, A.value = "", A.disabled = !0, A.selected = !0, x.appendChild(A)
                            }
                            b = function (e) {
                            ...
                            break;
                        case "radio":
                            var B = z(_.content, D.radio);
                            B.innerHTML = "", b = function (e) {
                                e.forEach(function (e) {
                                    var t = M(e, 2),
                                        n = t[0],
                                        o = t[1],
                                    ...
                                    r.type = "radio", r.name = D.radio, r.value = n, j.inputValue.toString() === n.toString() && (r.checked = !0), i.innerHTML = o, i.insertBefore(r, i.firstChild), B.appendChild(i)
                                }), U(B);
    ...
    }), Ce.DismissReason = e, Ce.noop = function () {}, Ce.version = "7.25.0";
    var ke, xe, Ae = k((ke = Ce, xe = function (e) {
        function t() {
            return s(this, t), u(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
        }
        return a(t, ke), o(t, [{
